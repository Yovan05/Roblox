 ...
 * @author alexi
 */
public class CreateShow extends javax.swing.JDialog {
     ...
     */
    public CreateShow(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        if (tblMovies.getColumnModel().getColumnCount() > 0) {
            ...
            tblMovies.getColumnModel().getColumn(1).setHeaderValue("Pelicula");
        }
        ...
        if (tblEmployees.getColumnModel().getColumnCount() > 0) {
            ...
            tblEmployees.getColumnModel().getColumn(1).setHeaderValue("Pelicula");
        }
 ...
 //           Logger.getLogger(CreateShow.class.getName()).log(Level.SEVERE, null, ex);
        ...
        if(!(employeeId==0 || movieId==0 || roomId==0 || scheduleEmpty.length()==0 || txfDate.getText().length()==0)){
            ...
            if(ShowModel.save(employeeId, movieId, roomId, schedule, date)){
                dispose();
            }else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CreateShow.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CreateShow dialog = new CreateShow(new javax.swing.JFrame(), true);
